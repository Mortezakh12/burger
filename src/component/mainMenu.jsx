...
const foodObject = [
  ...
  {
    title: "همبرگر معمولی با قارچ",
    price: "8000",
    img: "./images/hamburger (1).png",
  },
  {
    title: "همبرگر مخصوص با قارچ",
    price: "8000",
    img: "./images/hamburger (1).png",
  },
  ...
  return (
    <>
      <div className="w-2/3 bg-gray-100 rounded-lg">
        <h1 className="text-center border-b-4 mt-5 pb-5 font-bold text-2xl">
          رستوران مک دونالد شعبه تهران
        </h1>
        <div className="grid grid-cols-2 gap-2 w-full overflow-y-auto px-12">
          {foodObject.map((item, index) => (
            <Food
              key={item.title}
              price={item.price}
              img={item.img}
